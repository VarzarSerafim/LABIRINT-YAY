...
background = os.path.join(path1, "background.JFIF")
...
class Button():
    def __init__(self, x, y, width, height, color1, color2, color_text, size_text, text, w_do):
        self.rect = pygame.Rect(x, y, width, height)
        self.color1 = color1
        self.color2 = color2
        self.color = color1
        self.w_do = w_do
        f1 = pygame.font.SysFont("Arial", size_text)                                             
        self.text = f1.render(text, True, color_text)
    def update(self):
...
class Menu():
    def __init__(self, screen):
        self.screen = pygame.transform.scale(screen, (scr_width, scr_height))
        self.buttons = list()
    def add_buttons(self, x, y, width, height, color1, color2, color_text, size_text, text, w_do):
        button = Button(x, y, width, height, color1, color2, color_text, size_text, text, w_do)
    ...
    def show_menu(self):
        ...
        while game == True:
            for e in pygame.event.get():
                ...
                #        if button.rect.collidepoint(e.pos[0], e.pos[1]) == True:
                #            self.color == self.color2
                if e.type == pygame.MOUSEBUTTONDOWN:
                    for button in self.buttons:
                        if button.rect.collidepoint(e.pos[0], e.pos[1]) == True:
                            if button.w_do == "Start":
                                game = False
                            elif button.w_do == "Options":
                                print('Настройки')
                            elif button.w_do == "Exit":
                                game = False
                                close += 1
...
menu.add_buttons(220, 60, 350, 60, (0, 150, 50), (150, 0, 50), (150, 150, 150), 50, "           Старт", "Start")
menu.add_buttons(220, 260, 350, 60, (0, 150, 50), (150, 0, 50), (150, 150, 150), 50, "       Настройки", "Options")
menu.add_buttons(220, 460, 350, 60, (0, 150, 50), (150, 0, 50), (150, 150, 150), 50, "           Выход", "Exit")
menu.show_menu()
